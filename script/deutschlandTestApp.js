angular.module('deutschlandTest', ['ngRoute'])
...
.controller('mainCtrl', function($scope, $http, $location) {
        ...
        $scope.deleteAnswer = function(id) {
            $http.delete('/api/answer_delete_dtschl/' + id)
                .success(function(data) {
                    $scope.answers = data;
                })
                .error(function(data) {
        ...
        $scope.updateQuestion = function() {
            $http.post('/api/question_update_dtschl', $scope.QuestionEdit)
                .success(function(data) {
                    //Antworten raussuchen mit selber fragenID
                    $scope.AnswersEdit.forEach(function(answer) {
                        answer.fragenID = $scope.QuestionEdit._id;
                        $http.post('/api/answer_update_dtschl', answer)
                            .success(function(data) {
                                $scope.answers = data;
                            })
                            .error(function(data) {
